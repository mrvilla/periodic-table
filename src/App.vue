<template>
  <div id="app" class="container-fluid">
    ...
    <chemical-elements :periodicList="periodicList" />
  </div>
</template>
...
.chemical-elements {
  ...
  grid-template-rows: repeat(1, 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr);
}
.chemical-element__wrapper {
  position: relative;
  padding: 0.4rem;
  border: 0.1rem solid;
  display: flex;
...
.chemical-element__symbol {
  font-size: 1rem;
  font-weight: bold;
}

.chemical-element__atomic-number {
  position: absolute;
  top: 2px;
  left: 4px;
  font-size: 0.6rem;
